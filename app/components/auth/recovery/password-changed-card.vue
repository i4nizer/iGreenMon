		...
		<v-card-text>
			<div class="d-flex flex-column align-center ga-3">
				...
				<span class="text-wrap text-grey-darken-3 text-center">
					Your iGreenMon account is now secured with your new
					password. All your ESP32 devices and automation settings
					remain intact.
				</span>
				...
				<span class="text-wrap text-grey-darken-3 text-center">
					Sign in with your new password to access your greenhouse
