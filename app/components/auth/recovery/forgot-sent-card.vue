		...
		<v-card-text>
			<div class="d-flex flex-column align-center ga-3">
				...
				<span class="text-wrap text-center text-grey-darken-3">
					...
					>. Click the link in the email to create a new password for
					your iGreenMon account.
				</span>
				...
				>
				<nuxt-link to="/auth/recovery/forgot" class="text-grey-darken-2"
...
counter.onUpdate(
	(count) => (resendBtnText.value = `Resend in ${count.toFixed(0)}s`)
)
